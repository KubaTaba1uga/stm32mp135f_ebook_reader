...
struct AppModule {
  void (*open)(void *, app_ctx_t, enum AppEventEnum, void *);
  void (*close)(void *);
  void (*destroy)(void *);
  void *module_data;
};
...
void app_module_open(app_module_t, app_ctx_t, enum AppEventEnum, void *);
...
void app_module_menu_select_book(app_module_t, app_ctx_t, enum AppEventEnum,  void *);
