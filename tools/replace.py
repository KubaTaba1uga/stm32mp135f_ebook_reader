...
def replace_in_file(path: str, old: str, new: str) -> bool:
    try:
        with open(path, "r", encoding="utf-8") as f:
            data = f.read()
    except (UnicodeDecodeError, PermissionError, IsADirectoryError) as err:
        print("ERROR: ", err)
...
def replace_in_dir(root_dir: str, old: str, new: str):
    print("root_dir arg =", root_dir, "abs =", os.path.abspath(root_dir), "isdir =", os.path.isdir(root_dir))
